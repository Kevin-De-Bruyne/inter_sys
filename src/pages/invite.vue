                    ...
                    <template  v-if="list">
                       ...
                       <div class="pic" v-else>
                        ...
                        <div class="info">
                         ...
                         <span class="date" style="color:rgb(5,129,253)">邀请状态：{{invite_status(item.status)}}</span>
                        </div>
                        <div class="icon">
...
export default {
    ...
    methods:{
        ...
        listDetail(index,id){
            this.$router.push({path:'/invite_detail',query:{index:index,id:id}})
            this.$store.commit('changeTab',index)
        },
         getList(){
         this.$get('/api/client/invitelist',{
    ...
    mounted(){
      ...
      var scrollHeight = document.documentElement.scrollHeight||document.body.scrollHeight;
        ...
        //到了这个就可以进行业务逻辑加载后台数据了
          console.log("到了底部");
          if(that.page<that.last_page && that.$route.path=='/invite'){
            (that.page)++
